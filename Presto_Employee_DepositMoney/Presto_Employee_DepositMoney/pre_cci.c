# 1 "d:\\project\\poc_scripts\\devops_app\\presto_employee_depositmoney\\\\combined_Presto_Employee_DepositMoney.c"
...
# 1 "d:\\project\\poc_scripts\\devops_app\\presto_employee_depositmoney\\\\combined_Presto_Employee_DepositMoney.c" 2
...
# 2 "d:\\project\\poc_scripts\\devops_app\\presto_employee_depositmoney\\\\combined_Presto_Employee_DepositMoney.c" 2
...
# 3 "d:\\project\\poc_scripts\\devops_app\\presto_employee_depositmoney\\\\combined_Presto_Employee_DepositMoney.c" 2
...
# 4 "d:\\project\\poc_scripts\\devops_app\\presto_employee_depositmoney\\\\combined_Presto_Employee_DepositMoney.c" 2
...
Action()
{
   ...
   lr_end_transaction("Presto_Employee_01_HomePage",2);
	...
	lr_end_transaction("Presto_Employee_02_ClickLoginLink",2);
	...
	lr_end_transaction("Presto_Employee_03_SelectUser",2);
	...
	lr_end_transaction("Presto_Employee_04_Login",2);

	lr_think_time(2);
	
	lr_start_transaction("Presto_Employee_05_DepositMoney_Link");

	 

	web_reg_save_param("bank_id",
		"LB=Your Unique Employee Bank ID is: <b>",
		"RB= </b>",
		"Ord=1",
		"NotFound=ERROR",
		"Search=All",
	...
	web_url("Deposit Amount", 
		"URL=http://{URL}/Presto/emp/addtrans.jsp", 
		"Resource=0", 
		"RecContentType=text/html", 
	...
	lr_end_transaction("Presto_Employee_05_DepositMoney_Link",2);

	lr_output_message("bank id of logged in guy=%s",lr_eval_string("{bank_id}"));
	
	lr_think_time(2);
	
	lr_start_transaction("Presto_Employee_06_DepositMoney");

	 web_reg_find("Fail=NotFound",
		"Search=Body",
		"Text=Added Amount Successfully",
		"LAST");
		
	web_submit_data("deposit", 
		"Action=http://{URL}/Presto/emp/deposit", 
		"Method=POST", 
		"RecContentType=text/html", 
		"Referer=http://{URL}/Presto/emp/addtrans.jsp", 
		"Snapshot=t8.inf", 
		"Mode=HTTP", 
		"ITEMDATA", 
		"Name=depo.clid", "Value={clientid}", "ENDITEM", 
		"Name=depo.details", "Value=Add Money", "ENDITEM", 
		"Name=depo.amount", "Value={Deposit_Amount}", "ENDITEM", 
	...
	lr_end_transaction("Presto_Employee_06_DepositMoney",2);
...
# 221 "Action.c"
	...
	lr_end_transaction("Presto_Employee_07_logout",2);

	return 0;
}
# 5 "d:\\project\\poc_scripts\\devops_app\\presto_employee_depositmoney\\\\combined_Presto_Employee_DepositMoney.c" 2
...
# 6 "d:\\project\\poc_scripts\\devops_app\\presto_employee_depositmoney\\\\combined_Presto_Employee_DepositMoney.c" 2
