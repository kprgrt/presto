Action()
{
   ...
   lr_end_transaction("Presto_Employee_01_HomePage",LR_AUTO);
	...
	//Your Unique Employee Bank ID is: <b>567890 </b>
	...
	lr_end_transaction("Presto_Employee_05_DepositMoney_Link",LR_AUTO);
	...
	lr_end_transaction("Presto_Employee_06_DepositMoney",LR_AUTO);
